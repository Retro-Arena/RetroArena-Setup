...
function configure_lr-fbalpha() {
    ...
    addEmulator 1 "$md_id" "neogeo" "$md_inst/fbalpha_libretro.so"
    addEmulator 0 "$md_id-neocd" "neogeo" "$md_inst/fbalpha_libretro.so --subsystem neocd"
    addEmulator 1 "$md_id-neocd" "neocdz" "$md_inst/fbalpha_libretro.so --subsystem neocd"
    addEmulator 1 "$md_id" "fba" "$md_inst/fbalpha_libretro.so"

...
function gui_hurstythemes() {
    while true; do
        ...
        local cmd=(dialog --default-item "$default" --backtitle "Hursty's ES Themes Installer" --menu "Hursty's ES Themes Installer - (1230 Themes as at 14 June 2019)" 22 76 16)
